...
class HttpServer {
  constructor(node, blockchain, operator, miner) {
    ...
    this.app.post("/operator/wallets", async (req, res) => {
      ...
      if (eventID) {
        //event wallet
        let existingWalletOnBlockChain =
          operator.getRegisteredWalletByEventId(eventID);
        ...
        let existingWalletOnBlockchain =
          operator.getRegisteredWalletByStudentId(studentID);
  ...
  async createEventWalletTransaction(
    operator,
    eventID,
    publicKey,
    studentIDList,
    ...
    return new Promise(async (resolve, reject) => {
      ...
      try {
        ...
        let publicKeys = (await Promise.all(publicKeyPromises)).filter(
          (pk) => pk !== null,
        );
